# Импортирование сторонних библиотек и переменных из других файлов
import requests
import datetime
...
async def get_weather(message: types.Message):
    ...
    try:
        ...
        sunrise_timestamp = datetime.datetime.fromtimestamp(data["sys"]["sunrise"])  # Время восхода солнца
